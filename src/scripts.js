...
gulp.task('lazyLoading', function () {
  ...
  return gulp.src(path.join(conf.paths.src, '/'+lazy_index_file+'.js'))
...
//////////////////////////////////// To ignore the files which will be for lazy loading purpose which end with .lazy.js ///////////////////////////////////


gulp.task('buildOtherFiles', ['scripts', 'styles'], function () {
  return injectFiles('careclues');
});
...
var injectFiles = function(index_file) {
  ...
  var injectScripts = gulp.src([
    ...
    path.join('!' + conf.paths.src, '/**/*.lazy.js'), // To ignore the files which will be for lazy loading purpose which end with .lazy.js
